const translations = {
  bg: {
    ...
    step1_label: 'Събитие',
    step2_label: 'Дата',
    step3_label: 'Включено',
    step4_label: 'Контакти',
    step5_label: 'Резюме',
    s1_title: 'Изберете тип събитие',
    s2_title: 'Изберете дата и час',
    s3_title: 'Включено в наема',
    s3_sub: 'Следните услуги са включени в цената на залата.',
    s4_title: 'Вашите данни',
    s5_title: 'Преглед и изпращане',
  ...
  en: {
    ...
    step1_label: 'Event',
    step2_label: 'Date',
    step3_label: 'Included',
    step4_label: 'Contact',
    step5_label: 'Summary',
    s1_title: 'Choose Event Type',
    s2_title: 'Select Date & Time',
    s3_title: "What's Included",
    s3_sub: 'The following services are included in the venue rental.',
    s4_title: 'Your Details',
