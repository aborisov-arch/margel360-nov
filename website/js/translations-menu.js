...
const translations = {
  bg: {
    ...
    nav_drinks: 'Меню', nav_partners: 'Партньори', nav_contact: 'Контакти', nav_blog: 'Блог', nav_faq: 'Често задавани въпроси', nav_reserve: 'Запитване',
  ...
  en: {
    ...
    nav_drinks: 'Menu', nav_partners: 'Partners', nav_contact: 'Contacts', nav_blog: 'Blog', nav_faq: 'FAQ', nav_reserve: 'Enquiry',
