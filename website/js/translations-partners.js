const translations = {
  bg: {
    ...
    partners_sub: 'Кетъринг, декорация, певци, групи и DJ, с които работим',
    ...
    partners_cat_singer: 'Певци',
    partners_cat_band: 'Групи',
    partners_cat_dj: 'DJ',
    partners_cat_artist: 'Артисти',
  ...
  en: {
    ...
    partners_sub: 'The caterers, decorators, singers, bands and DJs we work with',
    ...
    partners_cat_singer: 'Singers',
    partners_cat_band: 'Bands',
    partners_cat_dj: 'DJs',
    partners_cat_artist: 'Artists',
